...
- **Documentation:** the receiver-side contract is documented in `docs/architecture/06-destinations.md` "Destination Consumer" and the wire format pinned in `consumers/webhook-sink/v1/src/types.ts` (`WebhookPayload`).
