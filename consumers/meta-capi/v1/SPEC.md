...
```text
consumers/meta-capi/v1/test/fixtures/normalized.ts                    builders
consumers/meta-capi/v1/test/fixtures/checkout-started.input.json      canonical event
consumers/meta-capi/v1/test/fixtures/checkout-started.output.json     Meta payload (illustrative shape)
```
