...
- [Blueprints](../../blueprints/README.md) — a runnable Next.js app carrying all three paths at once: browser SDK direct, browser SDK through a first-party relay, and Node SDK from the server, sharing one visitor identity
