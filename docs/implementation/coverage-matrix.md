...
| Topic isolation triggers and families | `03-redpanda-topics.md` | P0-007, P10-002, P11-008 |
| Per-project metrics labels | `03-redpanda-topics.md`, `08-observability-and-operations.md` | P10-002, P11-008 |
