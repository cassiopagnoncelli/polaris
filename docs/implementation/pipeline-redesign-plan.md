...
- **Merge safety.** Two guards against merge storms — the classic
  ...
  `@polaris/governance`) and a **merge-rate breaker** — a profile that exceeds the
