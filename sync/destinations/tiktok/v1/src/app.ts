/**
 * Service bootstrap for tiktok v1.
 *
 * Mirrors `sync/destinations/meta-capi/v1/src/app.ts`:
 *
 ...
 *   4. Build the `DestinationConsumer` runtime from the tiktok
...
export interface BuiltTikTokApp {
 ...
 * `sync/destinations/meta-capi/v1/src/app.ts` and `apps/ingester-api/src/app.ts`:
...
function buildConsumer(
  ...
  const consumer = createPolarisConsumer({
    ...
    consumerVersion: CONSUMER_VERSION,
    poison: { component: "tiktok", producer },
